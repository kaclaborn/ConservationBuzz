...
collocates_stopwords <- c("birdlife_international", "birdlife_partner", "birdlife", "nature_conservancy", 
                          "david_shepherd_wildlife_foundation", "david_shepherd")